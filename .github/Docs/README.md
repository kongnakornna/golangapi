...
## 🌟 Features
### 🚀 Core Features
- **🏭 Domain-Driven Design (DDD)** -(Entities/Value Objects)
...
- **🛠️ Event-Driven Design **
  - Event-Driven Design : หรือ สถาปัตยกรรมที่ขับเคลื่อนด้วยเหตุการณ์ (Event-Driven Architecture หรือ EDA) คือรูปแบบการออกแบบซอฟต์แวร์ที่
  - ระบบทำงานและสื่อสารกันผ่านการตรวจจับและตอบสนองต่อ เหตุการณ์ (Event) โดยเหตุการณ์หมายถึงการเปลี่ยนแปลงสถานะหรือสิ่งที่เกิดขึ้นในระบบ เช่น การคลิกปุ่ม การสั่งซื้อสินค้า หรือค่าจากเซ็นเซอร์
Event-Driven Design c หรือ สถาปัตยกรรมที่ขับเคลื่อนด้วยเหตุการณ์ 
- (Event-Driven Architecture หรือ EDA) คือรูปแบบการออกแบบซอฟต์แวร์ที่ระบบทำงานและสื่อสารกันผ่านการตรวจจับและตอบสนองต่อ เหตุการณ์ (Event) โดยเหตุการณ์หมายถึงการเปลี่ยนแปลงสถานะหรือสิ่งที่เกิดขึ้นในระบบ เช่น การคลิกปุ่ม การสั่งซื้อสินค้า หรือค่าจากเซ็นเซอร์
...
** 🛠️ Event-Driven Design / Event-Driven Architecture (EDA)**  
คือรูปแบบการออกแบบซอฟต์แวร์ที่ระบบทำงานและสื่อสารกันผ่าน “เหตุการณ์” (Event) โดยเหตุการณ์หมายถึงการเปลี่ยนแปลงสถานะหรือสิ่งที่เกิดขึ้นในระบบ เช่น การคลิกปุ่ม การสั่งซื้อสินค้า หรือค่าที่อ่านได้จากเซ็นเซอร์ แทนที่ฝ่ายหนึ่งจะเรียกอีกฝ่ายโดยตรง ระบบจะประกาศเหตุการณ์ออกไป แล้วให้ผู้ที่สนใจรับเหตุการณ์นั้นไปประมวลผลต่อเอง

### องค์ประกอบหลัก

1. **Event Source**  
   แหล่งที่สร้างเหตุการณ์ เช่น ผู้ใช้ เซ็นเซอร์ หรือฐานข้อมูล

2. **Event**  
   หน่วยข้อมูลที่บอกว่าเกิดอะไรขึ้น และโดยปกติจะไม่สามารถแก้ไขได้หลังจากถูกสร้างขึ้นแล้ว (Immutable)

3. **Publisher**  
   ผู้ผลิตเหตุการณ์ ทำหน้าที่ส่งเหตุการณ์ออกไปแบบอะซิงโครนัส (Asynchronous) โดยไม่ต้องรอผู้รับ

4. **Event Broker / Event Bus**  
   ศูนย์กลางในการรับ คัดกรอง และส่งต่อเหตุการณ์ไปยังผู้บริโภคที่เกี่ยวข้อง

5. **Subscriber**  
   ผู้รับเหตุการณ์ คอยฟังและตอบสนองเมื่อมีเหตุการณ์ที่ตนสนใจเกิดขึ้น

### หลักการสำคัญ

- **Asynchronous**: ผู้ส่งและผู้รับไม่จำเป็นต้องทำงานพร้อมกัน
- **Decoupling**: แต่ละส่วนไม่ผูกติดกันโดยตรง ทำให้แก้ไขหรือเปลี่ยนระบบได้ง่าย
- **Immutable Event**: เหตุการณ์ที่เกิดขึ้นแล้วถือเป็นข้อเท็จจริง ไม่แก้ไขย้อนหลัง
- **Scalability**: สามารถขยายระบบได้ง่ายขึ้น เพราะแต่ละส่วนทำงานแยกกัน

### ข้อดี

- ระบบมีความยืดหยุ่นสูง
- ขยายขนาดได้ง่าย (Scalability)
- แต่ละส่วนทำงานเป็นอิสระต่อกัน
- เหมาะกับระบบ Real-time, Microservices, IoT และ Streaming

### ข้อจำกัดและความท้าทาย

- จัดการลำดับของเหตุการณ์ (Event Order) ได้ยาก
- ทดสอบและดีบักระบบกระจายได้ยาก
- อาจเกิดปัญหาเหตุการณ์ซ้ำ (Duplicate Event) หรือเหตุการณ์สูญหาย
- ต้องออกแบบเรื่อง Idempotency, Correlation ID, Observability และ Schema Registry ให้ดี

### สรุป

Event-Driven Design เป็นแนวทางที่ช่วยให้ระบบสื่อสารผ่านเหตุการณ์ ลดการผูกติดกันระหว่างบริการ และรองรับการขยายตัวได้ดี แต่ก็แลกมาด้วยความซับซ้อนในการจัดการลำดับเหตุการณ์ การทดสอบ และการติดตาม debugging ในระบบกระจาย ดังนั้นควรใช้เมื่อสถาปัตยกรรมนั้นต้องการความยืดหยุ่นหรือการประมวลผลแบบเรียลไทม์จริง ๆ

**อ้างอิง**  
[1] Medium – The Software Frontier, *Event-Driven Architecture (EDA): A Complete Guide to Real-Time Systems*  
[2] GeeksforGeeks – *Event-Driven Architecture System Design*
...
⸻
1) Pull Request ส่งโค้ดให้ทีมตรวจ
...
1. บทนำ 
2. บทนิยาม
3. ภาพรวมสถาปัตยกรรมระบบ infrastructure
4. เทคโนโลยีและเครื่องมือที่ใช้
5. Queue Management  
6. Data Layer และการจัดเก็บข้อมูล
7. Backend Services REST API โดยใช้ Clean Architecture   
   - ใช้ (Golang) Golang DDD ใช้ interface  ใช้ Modular  REST API project structure Redis  
   - PostgreSQL queue management system  Jwt APIKEY  SocketIO
8. Backend Services REST API โดยใช้ Clean Architecture ใช้ (Python)  Django and FastAPI  
9.  Databse PostgreSQL  InfluxDB 
10. Frontend Dashboard (Tabler.io + Angularjs)
11. Frontend Dashboard (Tabler.io + ReactJs)
12. AI knime framwork, openclaw framwork
13. Monitoring, Logging และ CI/CD  monitoring grafana prometheus
14. Workflow Automation ด้วย [knime](https://www.knime.com/) [openclaw](https://openclaw.ai/)
15. ความปลอดภัย (Security)
16. การทดสอบระบบ
17. เอกสารประกอบและคู่มือ
18. Workflow การทำงาน
19. Code Review Workflow
20. gitflow workflow action
21. Task Lists และ Checklists
22. ภาคผนวก
...
- `air`: hot-reload (ใช้ `.\air.cmd` หรือ `go run github.com/air-verse/air@latest` บน Windows 11 ที่ AppLocker block `air.exe`)
...
#### Hot Reload (air)
```bash
# Windows 11 ที่ AppLocker block air.exe ใน C:\Users\...\go\bin\air.exe
# ใช้ .air.cmd หรือ go run แทน:
.\air.cmd
# หรือ
...
- [x] Auth: RefreshToken UC/repo/presenter
- [x] Job: full CRUD + status workflow + service/part/symptom/DTC
- [x] Customer: CRUD + Car management + phone/plate search
- [x] Quotation: CRUD + Approve/Reject + PDF + part/service
- [x] PO: full lifecycle (DRAFT→SENT→CONFIRMED→SHIPPED→RECEIVED)
- [x] Payment: payment + receipt + refund + outstanding balance
- [x] Dashboard: stats/revenue/top-parts/job-status
- [x] Document: file upload/download management
- [x] Email: send + SMTP config + log history
- [x] Batch: batch job CRUD + run + logs
- [x] i18n: multi-language translation
- [x] WOS: web order system
- [x] SQL schema + triggers for all new modules
- [x] Seed data for demo/testing
- [x] Module documentation manual
- [x] All modules compile (`go build ./...`), `go vet ./...`, `go test ./...` pass
...
go mod vendor
.\air.cmd  # หรือ go run github.com/air-verse/air@latest


 ```
# Auto Run 
 
# Windows 11: ใช้ .air.cmd หรือ go run แทน air.exe ที่ถูก AppLocker block
.\air.cmd
...
- https://github.com/kongnakornna/golangapi/blob/main/Book/BookGolang1.md
- **นักพัฒนาที่มีประสบการณ์** สามารถข้ามไปยังภาคที่ 7-9 เพื่อศึกษา Clean Architecture, DDD และการผสานระบบภายนอก
- https://github.com/kongnakornna/golangapi/tree/main/project_manamet/sulution
- **ทีมพัฒนา** สามารถนำ Task List Template และ Checklist Template ไปปรับใช้ในการทำงาน
- https://github.com/kongnakornna/golangapi/tree/main/project_manamet/Template
- **Design Thinking  & Business Model Canvas (BMC) - Design & Implementation Package **
- https://github.com/kongnakornna/golangapi/tree/main/project_manamet/DesignThinking
---
...
# 3. Migrate ฐานข้อมูล (ใช้คำสั่งจาก cmd/api/main.go)
go run cmd/api/main.go migrate

# 4. สร้าง Swagger docs (ใช้ -g ชี้ไฟล์หลัก)
swag init -g cmd/api/main.go

# 5. Vendor dependencies (ถ้าต้องการ)
go mod vendor

# 6. วิ่งทดสอบทุก package
go test ./...

# 7. รันด้วย Air (hot-reload) หรือใช้ go run
air
