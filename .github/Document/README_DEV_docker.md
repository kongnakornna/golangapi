...
PS C:\github\icmongolang> docker-compose up
#1 [internal] load local bake definitions
#1 reading from stdin 939B done
#1 DONE 0.0s

#2 [backend internal] load build definition from Dockerfile.dev
#2 transferring dockerfile: 445B done
#2 DONE 0.0s

#3 [worker internal] load metadata for docker.io/library/golang:1.20-alpine
#3 DONE 1.0s

#4 [backend internal] load .dockerignore
#4 transferring context: 1.81kB done
#4 DONE 0.0s

#5 [worker 1/6] FROM docker.io/library/golang:1.20-alpine@sha256:e47f121850f4e276b2b210c56df3fda9191278dd84a3a442bfe0b09934462a8f
#5 resolve docker.io/library/golang:1.20-alpine@sha256:e47f121850f4e276b2b210c56df3fda9191278dd84a3a442bfe0b09934462a8f 0.0s done
#5 DONE 0.0s
...
#7 [worker 3/6] RUN go install github.com/cosmtrek/air@v1.42.0
#7 CACHED

#8 [worker 2/6] WORKDIR /app
#8 CACHED

#9 [worker 4/6] RUN go install github.com/roerohan/wait-for-it@v0.2.13
#9 CACHED

#10 [worker 5/6] COPY go.mod go.sum ./
#10 CACHED

#11 [worker 6/6] RUN go mod download
#11 0.246 go: errors parsing go.mod:
#11 0.246 /app/go.mod:3: invalid go version '1.25.0': must match format 1.23
#11 ERROR: process "/bin/sh -c go mod download" did not complete successfully: exit code: 1
------
 > [worker 6/6] RUN go mod download:
0.246 go: errors parsing go.mod:
0.246 /app/go.mod:3: invalid go version '1.25.0': must match format 1.23
------
[+] up 0/2
 - Image icmongolang-backend Building                                                                                                                                     2.0s
 - Image icmongolang-worker  Building                                                                                                                                     2.0s
Dockerfile.dev:13

--------------------

  11 |     # Copy dependency files and download modules
  ...
  15 |     # Default command (can be overridden by compose)                                                                                                                   
                                                                                                                                                                              
--------------------                                                                                                                                                          
                                                                                                                                                                              
target backend: failed to solve: process "/bin/sh -c go mod download" did not complete successfully: exit code: 1                                                             
                                                                                                                                                                              
                                                                                                                                                                              
                                                                                                                                                                              
View build details: docker-desktop://dashboard/build/default/default/qfkwqbc0lvyz5b8p9z82m1z1t                                                                                
                                                                                                                                                                              
PS C:\github\icmongolang> Test-NetConnection -ComputerName localhost -Port 5432                                                                                               
...
PS C:\github\icmongolang> Test-NetConnection -ComputerName localhost -Port 6379
