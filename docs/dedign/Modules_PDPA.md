...
แปลงเป็น
 ...
 หรือ สถาปัตยกรรมที่ขับเคลื่อนด้วยเหตุการณ์ (Event-Driven Architecture หรือ EDA) คือรูปแบบการออกแบบซอฟต์แวร์ที่ระบบทำงานและสื่อสารกันผ่านการตรวจจับและตอบสนองต่อ เหตุการณ์ (Event) โดยเหตุการณ์หมายถึงการเปลี่ยนแปลงสถานะหรือสิ่งที่เกิดขึ้นในระบบ เช่น การคลิกปุ่ม การสั่งซื้อสินค้า หรือค่าจากเซ็นเซอร์ [1] (https://translate.google.com/translate?u=https://medium.com/the-software-frontier/event-driven-architecture-eda-a-complete-guide-to-real-time-systems-974f612dc6b5&hl=th&sl=en&tl=th&client=sge)
