...
type PaymentUseCaseI interface {
	internal.UseCaseI[models.Payment]
	...
	ProcessRefund(ctx context.Context, id uuid.UUID, amount float64, reason string) (*models.Payment, error)
	CancelPayment(ctx context.Context, id uuid.UUID, reason string) error
}
