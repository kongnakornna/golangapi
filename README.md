...
[GIN-debug] GET    /api/v1/                  --> golang-rest-api-template/pkg/api.(*bookRepository).Healthcheck-fm (8 handlers)
[GIN-debug] GET    /api/v1/books             --> golang-rest-api-template/pkg/api.(*bookRepository).FindBooks-fm (9 handlers)
[GIN-debug] POST   /api/v1/books             --> golang-rest-api-template/pkg/api.(*bookRepository).CreateBook-fm (10 handlers)
[GIN-debug] GET    /api/v1/books/:id         --> golang-rest-api-template/pkg/api.(*bookRepository).FindBook-fm (9 handlers)
[GIN-debug] PUT    /api/v1/books/:id         --> golang-rest-api-template/pkg/api.(*bookRepository).UpdateBook-fm (9 handlers)
[GIN-debug] DELETE /api/v1/books/:id         --> golang-rest-api-template/pkg/api.(*bookRepository).DeleteBook-fm (9 handlers)
[GIN-debug] POST   /api/v1/login             --> golang-rest-api-template/pkg/api.(*userRepository).LoginHandler-fm (9 handlers)
[GIN-debug] POST   /api/v1/register          --> golang-rest-api-template/pkg/api.(*userRepository).RegisterHandler-fm (9 handlers)
